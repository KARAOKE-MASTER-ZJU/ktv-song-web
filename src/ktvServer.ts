        ...
        <div class="w-full max-w-sm bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 animate-pop">
            ...
            <div class="mt-8 flex flex-col items-center gap-4">
                <div class="flex items-center gap-4">
                    <a href="https://github.com/starfreedomx/ktv-song-web" target="_blank" class="text-slate-400 hover:text-indigo-600 transition-colors flex items-center gap-1.5">
